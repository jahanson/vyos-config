...
set firewall ipv4 name servers-iot rule 120 action 'accept'
set firewall ipv4 name servers-iot rule 120 description 'Rule: accept_home_automation'
set firewall ipv4 name servers-iot rule 120 protocol 'tcp'
set firewall ipv4 name servers-iot rule 120 source group address-group 'home_automation'
set firewall ipv4 name servers-iot rule 130 action 'accept'
set firewall ipv4 name servers-iot rule 130 description 'Rule: accept_home_automation'
set firewall ipv4 name servers-iot rule 130 protocol 'icmp'
set firewall ipv4 name servers-iot rule 130 source group address-group 'home_automation'
...
set firewall ipv4 name trusted-local rule 430 action 'accept'
set firewall ipv4 name trusted-local rule 430 description 'Rule: accept_vnstat_web'
set firewall ipv4 name trusted-local rule 430 destination port '8685'
set firewall ipv4 name trusted-local rule 430 protocol 'tcp'
